...
FEED_URL=${2:-"https://raw.githubusercontent.com/tokenbar/tokenbar/main/appcast.xml"}
...
DOWNLOAD_URL_PREFIX=${SPARKLE_DOWNLOAD_URL_PREFIX:-"https://github.com/tokenbar/tokenbar/releases/download/v${VERSION}/"}
