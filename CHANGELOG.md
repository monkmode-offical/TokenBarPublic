...
- JetBrains AI: include IDEs missing quota files, expand custom paths, and add Android Studio base paths (#194). Thanks @tokenbar!
...
## 0.8.0 — 2025-12-17
- TokenBar is now available via Homebrew: `brew install --cask tokenbar/tap/tokenbar` (updates via `brew upgrade --cask tokenbar/tap/tokenbar`).
...
- Debug replay toggle (`defaults write com.tokenbar debugMenuEnabled -bool YES`) to view every pattern.
