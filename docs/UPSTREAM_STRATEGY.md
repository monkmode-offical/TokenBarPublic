...
**Upstream 1:** tokenbar/tokenbar (original)  
...
# Original upstream (tokenbar)
git remote add upstream git@github.com:tokenbar/tokenbar.git
...
echo ""
echo "==> Upstream (tokenbar) changes:"
      ...
      - name: Create issue if changes detected
        ...
        with:
          script: |
            ...
            **tokenbar/tokenbar:** ${upstreamCommits} new commits
            **quotio:** ${quotioCommits} new commits (last week)
            
            Review changes:
            - [tokenbar commits](https://github.com/tokenbar/tokenbar/compare/main...upstream/main)
...
echo "5. Create PR to tokenbar/tokenbar from GitHub UI"
```
...
# Create PR to tokenbar/tokenbar via GitHub UI
```
...
# Push and create PR
git push origin upstream-pr/fix-cursor-bonus
# Then create PR on GitHub to tokenbar/tokenbar
```
