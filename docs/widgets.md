...
pluginkit -m -p com.apple.widgetkit-extension -i com.tokenbar.widget -vv
```
Notes:
...
```
pluginkit -a "$WAPPEX"
pluginkit -e use -p com.apple.widgetkit-extension -i com.tokenbar.widget
```
- Check for duplicates (old installs or version precedence):
```
pluginkit -m -D -p com.apple.widgetkit-extension -i com.tokenbar.widget -vv
```
...
- Widget bundle id should be `com.tokenbar.widget`.
