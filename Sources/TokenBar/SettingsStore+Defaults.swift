...
extension SettingsStore {
    ...
    var showDockIcon: Bool {
        get { self.defaultsState.showDockIcon }
        set {
            self.defaultsState.showDockIcon = newValue
            self.userDefaults.set(newValue, forKey: "showDockIcon")
    ...
    var usageBudgetModeEnabled: Bool {
        get { self.defaultsState.usageBudgetModeEnabled }
        set {
            self.defaultsState.usageBudgetModeEnabled = newValue
            self.userDefaults.set(newValue, forKey: "usageBudgetModeEnabled")
        }
    }

    var usageBudgetTargetDays: Int {
        get { max(1, min(30, self.defaultsState.usageBudgetTargetDays)) }
        set {
            let clamped = max(1, min(30, newValue))
            self.defaultsState.usageBudgetTargetDays = clamped
            self.userDefaults.set(clamped, forKey: "usageBudgetTargetDays")
        }
    }

    var usageAlertNotificationsEnabled: Bool {
        get { self.defaultsState.usageAlertNotificationsEnabled }
        set {
            self.defaultsState.usageAlertNotificationsEnabled = newValue
            self.userDefaults.set(newValue, forKey: "usageAlertNotificationsEnabled")
        }
    }

    var usageAlertThresholdsDisplay: String {
        get { self.defaultsState.usageAlertThresholdsRaw }
        set {
            let normalized = Self.normalizedUsageAlertThresholds(newValue)
            self.defaultsState.usageAlertThresholdsRaw = normalized
            self.userDefaults.set(normalized, forKey: "usageAlertThresholds")
        }
    }

    var usageAlertThresholds: [Int] {
        Self.parseUsageAlertThresholds(self.defaultsState.usageAlertThresholdsRaw)
    }

    var sessionTrackingModeEnabled: Bool {
        get { self.defaultsState.sessionTrackingModeEnabled }
        set {
            self.defaultsState.sessionTrackingModeEnabled = newValue
            self.userDefaults.set(newValue, forKey: "sessionTrackingModeEnabled")
        }
    }

    private var overviewPrioritySortRaw: String? {
        get { self.defaultsState.overviewPrioritySortRaw }
        set {
            self.defaultsState.overviewPrioritySortRaw = newValue
            if let newValue {
                self.userDefaults.set(newValue, forKey: "overviewPrioritySort")
            } else {
                self.userDefaults.removeObject(forKey: "overviewPrioritySort")
            }
        }
    }

    var overviewPrioritySortMode: OverviewPrioritySortMode {
        get {
            OverviewPrioritySortMode(rawValue: self.overviewPrioritySortRaw ?? "") ?? .mostConstrained
        }
        set {
            self.overviewPrioritySortRaw = newValue.rawValue
        }
    }

    static func parseUsageAlertThresholds(_ raw: String) -> [Int] {
        let parsed = raw
            .split(separator: ",")
        ...
        let uniqueSorted = Array(Set(parsed)).sorted()
        return uniqueSorted.isEmpty ? [60, 80, 95] : uniqueSorted
    }

    static func normalizedUsageAlertThresholds(_ raw: String) -> String {
        let normalized = Self.parseUsageAlertThresholds(raw)
    ...
    var licenseKey: String {
        get { self.defaultsState.licenseKey }
        set {
            let normalized = newValue.trimmingCharacters(in: .whitespacesAndNewlines)
            self.defaultsState.licenseKey = normalized
            self.userDefaults.set(normalized, forKey: "licenseKey")
        }
    }

    var licenseServerURL: String {
        get { self.defaultsState.licenseServerURL }
        set {
            let normalized = LicenseService.normalizedServerURL(newValue)
            self.defaultsState.licenseServerURL = normalized
            self.userDefaults.set(normalized, forKey: "licenseServerURL")
        }
    }

    var licenseStateRaw: String {
        get { self.defaultsState.licenseStateRaw }
        set {
            self.defaultsState.licenseStateRaw = newValue
            self.userDefaults.set(newValue, forKey: "licenseState")
        }
    }

    var licenseStatusMessage: String {
        get { self.defaultsState.licenseStatusMessage }
        set {
            self.defaultsState.licenseStatusMessage = newValue
            self.userDefaults.set(newValue, forKey: "licenseStatusMessage")
        }
    }

    var licenseLastVerifiedAt: Date? {
        get { self.defaultsState.licenseLastVerifiedAt }
        set {
            self.defaultsState.licenseLastVerifiedAt = newValue
            if let newValue {
                self.userDefaults.set(newValue, forKey: "licenseLastVerifiedAt")
            } else {
                self.userDefaults.removeObject(forKey: "licenseLastVerifiedAt")
            }
        }
    }
