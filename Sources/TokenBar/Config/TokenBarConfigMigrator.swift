...
struct TokenBarConfigMigrator {
    ...
    private static let legacyKeychainMigrationAttemptedKey = "TokenBarConfigLegacyKeychainMigrationAttemptedV1"
        ...
        stores: LegacyStores) -> TokenBarConfig
    {
        ...
        let shouldAttemptLegacyKeychainMigration = !userDefaults.bool(forKey: self.legacyKeychainMigrationAttemptedKey)
        ...
        if shouldAttemptLegacyKeychainMigration {
            ...
            userDefaults.set(true, forKey: self.legacyKeychainMigrationAttemptedKey)
        }
