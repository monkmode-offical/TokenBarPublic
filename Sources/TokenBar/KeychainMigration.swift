...
enum KeychainMigration {
    ...
    static let itemsToMigrate: [MigrationItem] = [
        MigrationItem(service: "com.tokenbar", account: "codex-cookie"),
        MigrationItem(service: "com.tokenbar", account: "claude-cookie"),
        MigrationItem(service: "com.tokenbar", account: "cursor-cookie"),
        MigrationItem(service: "com.tokenbar", account: "factory-cookie"),
        MigrationItem(service: "com.tokenbar", account: "minimax-cookie"),
        MigrationItem(service: "com.tokenbar", account: "minimax-api-token"),
        MigrationItem(service: "com.tokenbar", account: "augment-cookie"),
        MigrationItem(service: "com.tokenbar", account: "copilot-api-token"),
        MigrationItem(service: "com.tokenbar", account: "zai-api-token"),
        MigrationItem(service: "com.tokenbar", account: "synthetic-api-key"),
    ]
