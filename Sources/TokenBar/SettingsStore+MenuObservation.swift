...
extension SettingsStore {
    var menuObservationToken: Int {
        ...
        _ = self.usageBudgetModeEnabled
        _ = self.usageBudgetTargetDays
        _ = self.usageAlertNotificationsEnabled
        _ = self.usageAlertThresholdsDisplay
        _ = self.sessionTrackingModeEnabled
        _ = self.overviewPrioritySortMode
