...
final class StatusItemController: NSObject, NSMenuDelegate, StatusItemControlling {
    ...
    var runningProvidersCache: Set<UsageProvider> = []
    var runningProvidersCacheUpdatedAt: Date = .distantPast
    ...
    var shouldMergeIcons: Bool {
        self.settings.mergeIcons && !self.store.enabledProviders().isEmpty
    }
