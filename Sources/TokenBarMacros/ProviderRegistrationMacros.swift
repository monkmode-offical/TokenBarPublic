...
public struct ProviderDescriptorRegistrationMacro: PeerMacro {
        ...
        in context: some MacroExpansionContext) throws -> [DeclSyntax]
    {
        ...
        let registerName = "_TokenBarDescriptorRegistration_\(typeName)"
        return [
            DeclSyntax(
...
public struct ProviderImplementationRegistrationMacro: PeerMacro {
        ...
        in context: some MacroExpansionContext) throws -> [DeclSyntax]
    {
        ...
        let registerName = "_TokenBarImplementationRegistration_\(typeName)"
        return [
            DeclSyntax(
...
@main
struct TokenBarMacroPlugin: CompilerPlugin {
